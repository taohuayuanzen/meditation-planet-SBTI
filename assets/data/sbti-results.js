...
window.MEDITATION_PLANET_SBTI_RESULTS = {
    ...
    "regularTypes": [
        ...
        },
        {
            ...
            "intro": "等着我草根逆袭。",
            "desc": "恭喜！您并非草根，您是犬儒主义先贤第欧根尼失散多年的精神传人，因为草根的全称是 Diogenes' Original Realist - sage。Dior-s人格，是对当代消费主义陷阱和成功学PUA最彻底的蔑视。他们不是\"不求上进\"，而是早已看穿一切\"上进\"的尽头不过是更高级的牢房。草根有着大智慧。当别人在追逐风口，被时代的巨浪拍得七荤八素时，Dior-s早已在自己的精神木桶里晒着太阳，达到了\"人桶合一\"的至高境界。他们信奉的不是空话，是经过亿万次实践检验的物理法则与生物本能：一、躺着比站着舒服；二、饭点到了就得干饭。",
            "sensitive": false
        },
        {
            "code": "BOSS",
        ...
        },
        {
            ...
            "intro": "我没死，我只是在睡觉。",
            "desc": "恭喜您，您测出了全中国最稀有的装死人格。群里99+条消息您可以视而不见，但当有人发出\"@全体成员 还有半小时就截止了\"的这一个通牒时，您也许会像刚从千年古墓里苏醒一样，缓缓地敲出一个\"收到\"，然后在29分钟内，交出一份虽然及格的答卷。是的，直到\"死线\"这个唯一的、最高权限的指令出现，您就真正爆发了，不鸣则已，一鸣惊人。您向宇宙证明了一个真理：有时什么都不做，就不会做错。",
            "sensitive": false
        },
        {
            "code": "POOR",
        ...
        },
        {
            ...
            "intro": "我真的...是废物吗？",
            "desc": "恭喜您，您测出的不是一个普通人格，您是一种极其珍稀的、仅占世界人口0.0001之一的——【废物】。废物们的自尊通常有些脆弱，缺乏安全感，偶尔也会缺乏主见，因此这种人格能精确地感知到周围最强的那个 WiFi 信号——也就是他们心里最可靠的人。走进【废物】人格的生活，就像走进了一个顶级兰花温室：需要精确控制温度、湿度，以及每天定时进行\"我爱你\"的言语光合作用。给废物一颗糖，他们会还你一个完全信任你、亮晶晶的眼神。你未必是废物，你只是太没防备，太容易认真。",
            "sensitive": true
        }
    ],
    "specialTypes": {
        "HHHH": {
            ...
            "pattern": "",
            "intro": "哈哈哈哈哈哈。",
            "desc": "恭喜您！由于您的思维回路过于清奇，标准人格库已全面崩溃。第一人格匹配率只有60％以下时，系统才会为您强制匹配这个人格——【HHHH - 傻乐者】。这个人格有什么特质？哈哈哈哈哈哈哈哈哈哈哈哈！对不起，这就是全部的特质了。您可以查看十五维度进行不专业的评估实在是抱歉！作者设置人格时没有考虑全面，因此才会出现这样的状况。哈哈哈哈哈哈……笑着笑着，我便哭了出来。怎么会有人的脑回路这么新奇。",
            "sensitive": true,
        ...
        "DRUNK": {
            ...
            "sensitive": true,
            "trigger": "特殊题中选择「将白酒灌在保温杯当白开水喝」对应选项（见下表特殊2选项 B）。",
            "kind": "hidden"
        }
    }
};
